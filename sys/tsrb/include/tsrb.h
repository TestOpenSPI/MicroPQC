 ...
 */
__STATIC_INLINE void tsrb_init(tsrb_t *rb, char *buffer, unsigned bufsize)
{
 ...
 * @return      1   otherwise
 */
__STATIC_INLINE int tsrb_empty(const tsrb_t *rb)
{
 ...
 */
__STATIC_INLINE unsigned int tsrb_avail(const tsrb_t *rb)
{
 ...
 * @return      1   otherwise
 */
__STATIC_INLINE int tsrb_full(const tsrb_t *rb)
{
 ...
 * @return      nr of available bytes
 */
__STATIC_INLINE unsigned int tsrb_free(const tsrb_t *rb)
{
